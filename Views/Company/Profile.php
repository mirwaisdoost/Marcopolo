       ...
       <div style="width: fit-content;">
            <div class=" pb-3 text-right">
               <form action="" method="post"> 
                    <a href="delete_company?show_id=<?php echo $row["id"]; ?>" class="btn btn-danger p-0 pr-2 pl-2" onclick="return confirm('Are you sure to delete the selected company?')">Delete</a>
                    <a href="update_company?show_id=<?php echo $row["id"]; ?>" class="btn btn-primary p-0 pr-2 pl-2" href="">Edit</a>
                </form>
            </div>
